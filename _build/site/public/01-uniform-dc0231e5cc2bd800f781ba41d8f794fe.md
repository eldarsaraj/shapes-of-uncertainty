...
But, does this make any sense? Do we ever get 3.5 when we roll a fair die? No, of course. So, this is not very useful in the immediate, practical sense. But, you can imagine a situation in which you'd want to know what could you expect in a uniformly distributed random process that repeats many times. For example, imagine you wanted to play a gambling game in which you had to pay an entrance fee of 3 dollars for each toss of the die, and you won as many dollars as the number on the die would show (so, if it shows 1 you get 1 dollar; if it shows 6, you get 6 dollars). The game could be played indefinitely.

Should you play this game?

This is where the 'typicality' of the uniform distribution can help. While it is uncertain how much money you could make on each individual toss (if you get a 1, you'll be at a loss for 2 dollars; if you get a 6, you'll pocket 3), the average across many games suggest that it would be profitable for you to partake in the game: for each 300 dollars you pay in entrance fees, you'd be expected to make 350, so you'd be profiting 50 dollars. This is about 16% profit, which is, if you think about it, not bad at all.
