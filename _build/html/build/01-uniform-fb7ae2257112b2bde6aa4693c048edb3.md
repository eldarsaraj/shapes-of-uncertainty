...
Namely, in both of these cases we have a set of _possible outcomes_. In the case of the coin, only two (heads and tails), and in the case of the die, six (1, 2, 3, 4, 5, 6). These possible outcomes form a set and we'll call such a set the range. In probability theory and statistics
