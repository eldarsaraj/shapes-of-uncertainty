...
How many attempts will it take before it works?
...
Imagine that each attempt has the same probability of success, say 30%.
...
You must fail \( k-1 \) times, and then succeed once.
