...
We have already encountered worlds where variation cancels out, where noise stabilizes, and where the average meaningfully describes what you are likely to encounter. But not all processes behave that way.
...
Instead of modeling the raw values directly, we model their logarithms. When the logarithms behave like a normal distribution—when their deviations are symmetric and cancel out—the original values become lognormally distributed.
