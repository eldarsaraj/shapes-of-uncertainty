...
Because the lottery is an example of a uniform randomness, each individual ticket has the same probability of outcome, the process is memoryless and doesn't accumulate
